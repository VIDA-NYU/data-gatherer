"""
Flan-T5 fine-tuning batch script.
Replicates the T5 section of Train_Validate_Test.ipynb.

Usage:
    python train_flan_t5.py [--args]

All arguments have sensible defaults matching the notebook.
"""
...
def parse_args():
    ...
    p.add_argument("--output_dir",   default="scripts/Local_model_finetuning/flan-t5-models")
...
def detect_device():
    if torch.cuda.is_available():
        ...
        return "cuda", False, has_bf16   # (device_str, fp16, bf16)
